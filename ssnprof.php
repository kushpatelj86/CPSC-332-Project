...
<?php
    ...
    else
    {
        ...
        $sql = "SELECT C.COURSE_TITLE, CS.COURSE_SECTION_CLASSROOM, CS.COURSE_SECTION_MEETING_DAYS,CS.COURSE_SECTION_START_TIME,CS.COURSE_SECTION_END_TIME, D.DEPARTMENT_UNIQUE_NUMBER 
        FROM COURSE C, COURSE_SECTION CS, PROFESSOR P, DEPARTMENT D WHERE P.PROFESSOR_SOCIAL_SECURITY_NUMBER=$ssnProf 
        AND P.PROFESSOR_SOCIAL_SECURITY_NUMBER=CS.COURSE_SECTION_PROFESSOR_SSN  AND CS.COURSE_SECTION_COURSE_UNIQUE_NUMBER=C.COURSE_UNIQUE_NUMBER 
