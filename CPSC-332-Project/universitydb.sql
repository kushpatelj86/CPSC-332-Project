...
CREATE TABLE PREREQUISITE(
    PREREQUISITE_COURSE_UNIQUE_NUMBER INTEGER,
...
(03,'CS 110A',35,'T/TH','7:00 PM','8:15 PM',351, 'CPSC',543565396),
...
(17, 777999000, 05, 418, 'ISDS', 'B'), -- Ava Clark enrolled in CS 300 for course section 418
(18, 888111222, 06, 309, 'ISDS', 'B'), -- Lucas Lewis enrolled in CS 208 for course section 309
(19, 999222333, 01, 488, 'CPSC', 'A'), -- Zoe Robinson enrolled in CS 101 for course section 488
(20, 000333444, 02, 351, 'CPSC', 'B'), -- Ethan Hall enrolled in CS 110A for course section 351
(21, 111444555, 04, 332, 'CPSC', 'C'); -- Emma Young enrolled in CS 101 for course section 332
